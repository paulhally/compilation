...
// Les types
// cf EnumType pour connaitre les types autorises
// type simple:
...
public class Type {
	...
	private static int id; // identifiant unique
	...
	// Teste si deux types sont equivalents
	...
	// Calcule la premiere differences entre deux types
	// c'est-a-dire la presence d'une variable dans un 
